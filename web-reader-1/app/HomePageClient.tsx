...
const StoriesWithSkeletonLoading = dynamic(() => import('@/components/common/utils/StoriesWithSkeletonLoading'));
const StoryCard = dynamic(() => import('@/components/story/StoryCard'));
const StoryCardSkeleton = dynamic(() => import('@/components/story/StoryCardSkeleton'));
const Fire1 = dynamic(() => import('@/components/animations/fires/Fire1'));
const FireLine = dynamic(() => import('@/components/animations/fires/FireLine'));
